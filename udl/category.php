...
if( $queried_object->taxonomy ) {
  ...
  <div class="container tax-header">
    <div class="row mt-3">
      <div class="col-md-12">
        <hr>
        <h4>← <a href="<?php echo home_url(); ?>/initiatives-research">Initiatives &amp; Research</a></h4>
        <h1 class="single-category-title mb-md-5 mb-lg-5 mb-xl-5 mb-4"><?php echo $queried_object->name; ?></h1>
        <div class="initiative-photo mb-4"><img src="<?php echo $image['url']; ?>" alt="<?php echo $image['alt']; ?>" /></div>
      </div>
      ...
      <?php if( !empty( $stewards ) ) { ?>
        <h5 class="tag-title mb-1"><span class="box-wide-sm-black"></span>Stewards</h5>
        <?php foreach($stewards as $steward){ ?>
        <span class="box-sm-black"></span><span class="steward-name"><?php echo $steward['display_name'];?></span><br/>
        <?php }
        }
        ?>
    </div>
